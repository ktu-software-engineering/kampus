...
function SkeletonCard() {
  return (
    <div className="bg-white/70 rounded-2xl p-5 border border-[#e8e2d9] animate-pulse">
      ...
      <div className="h-3 bg-kk-blue/5 rounded-lg w-1/2 mb-4" />
...
export default function HocalarLoading() {
  return (
    <div className="min-h-screen flex flex-col bg-kk-beige relative overflow-x-hidden font-sans">
      ...
      <main className="flex-grow relative z-10 pt-24 pb-16 px-4 md:px-8 max-w-7xl mx-auto w-full">
        <div className="mb-8">
          <div className="h-9 bg-kk-blue/15 rounded-xl w-48 mb-2 animate-pulse" />
        ...
        <div className="flex gap-3 mb-6">
          ...
          <div className="h-10 bg-white/70 rounded-xl w-32 animate-pulse border border-[#e8e2d9]" />
          <div className="h-10 bg-white/70 rounded-xl w-36 animate-pulse border border-[#e8e2d9] ml-auto" />
        </div>
        {/* Kart grid */}
