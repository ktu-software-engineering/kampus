    ...
    <div className="flex h-screen bg-kk-beige-dark dark:bg-zinc-950 text-slate-800 dark:text-slate-300 font-sans transition-colors duration-500">
      ...
      <aside className="w-72 bg-white dark:bg-zinc-900 border-r border-slate-200 dark:border-zinc-800 flex flex-col shadow-sm z-10 transition-colors duration-500">
        <div className="p-8 border-b border-slate-100 dark:border-zinc-800 flex flex-col gap-1">
          <h2 className="text-2xl font-bold text-kk-blue dark:text-white font-serif tracking-tight">
            KampusKarne
          </h2>
          <span className="text-xs font-semibold text-kk-gold uppercase tracking-widest">
            Yönetici Paneli
          </span>
        </div>
        ...
        <nav className="flex-1 px-4 py-6 space-y-1.5 overflow-y-auto">
          ...
          >
            <LayoutDashboard size={20} className={pathname === "/admin" ? "text-kk-blue-light" : ""} />
            Genel Bakış
          </Link>
          <Link 
            href="/admin/users" 
          ...
          >
            ...
            <span className="bg-kk-gold/10 text-kk-gold py-0.5 px-2 rounded-sm text-xs font-bold">8</span>
          </Link>
        </nav>

        <div className="p-4 border-t border-slate-100 dark:border-zinc-800 space-y-1">
          <ThemeToggle variant="inline" />
          <Link href="#" className="flex items-center gap-3 px-4 py-3 text-slate-500 dark:text-zinc-400 hover:text-kk-blue dark:hover:text-white hover:bg-slate-50 dark:hover:bg-zinc-800 rounded font-medium transition-colors">
            <Settings size={20} />
            Ayarlar
          </Link>
